...
#
# Наушники после примерки РЕЖУТСЯ надвое (tools\split-sprite.ps1): дальняя
# чашка уходит за призрака, потому что голова чуть повёрнута. Прямоугольник
# разреза — x 61..85, y 21..48 в процентах кадра призрака.
#
# Команда целиком:
