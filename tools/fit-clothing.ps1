...
#   наушники   w=69   cx=50.5   cy=27
#   шляпа      w=59   cx=48.5   cy=8
#
# Наушники больше НЕ режутся надвое. Пока они были маленькие (w=48), дальняя
# чашка налезала на голову и её прятали за призраком. Владелец прислал
# референс, где наушники крупные: на w=69 обе чашки выходят за силуэт головы,
# прятать нечего, и берётся целая картинка «наушники (новые, вырезано).png».
# Урок: сначала пробовать РАЗМЕР, и только если не помогло — разрез.
#
# Команда целиком:
