/**
 * ЭВОЛЮЦИЯ ПРИЗРАКА — полноэкранный праздник при переходе на новую стадию.
 *
 * Стадий пять (Зритель → Ученик → Моделлер → Художник → Творец), их список
 * и уровни, на которых они наступают, — в `lib/pet-config.ts`.
 *
    ...
    <AnimatePresence>
      {evolution && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[80] flex items-center justify-center px-8 bg-slate-900/70 backdrop-blur-sm"
        >
